<div class="details index">
	...
	<tr>
		...
		<td><?php echo h($detail['Detail']['lowest']); ?>&nbsp;</td>
		<td><?php echo h($detail['Detail']['amount']); ?>&nbsp;</td>
		<td><?php echo h($detail['Detail']['unit']); ?>&nbsp;</td>
		<td><?php echo h($detail['Detail']['store']); ?>&nbsp;</td>
		<td><?php echo h($detail['Detail']['date']); ?>&nbsp;</td>
